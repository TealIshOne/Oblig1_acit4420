...
test1=part.instanciate_profile(profile)
...
test4=sesMa(profile1, data1,data1,data1,data1) #rest
# test4=sesMa(profile1, data2,data2,data2,data2) #mod
# test4=sesMa(profile1, data3,data3,data3,data3) #high
# test4=sesMa(profile1, data4,data4,data4,data4) #bad
# test4=sesMa(profile1, data5,data5,data5,data5) #rec
test4=sesMa(profile1, data5,data5,data5,data5) #varry

print("*recoveryTracker*")
rec_trac, rec_trac_msg=test4.recoveryTracker()
# print(rec_trac)
# print(rec_trac_msg)
print("*validate all (child)*")
inv,v=test4.ValidateAll()
print(inv)
...
# print(maj)
print("**********print job*********")
obj=test4.SessionLogPrint(hr_i,sr_i,temp_i,al_i, maj, rec_trac)
if isinstance(obj,list):
    print(*obj, sep='\n', end="\n")
else:
    print("printing data summary failed")

info_Dict=test4.data_dict(hr_i,sr_i,temp_i,al_i, maj, rec_trac, len(invalid) )
print(info_Dict)
